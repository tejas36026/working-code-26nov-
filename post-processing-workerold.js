...
console.log('type :>> ', type);
    ...
    async function processVariation(leftUpperArmAngle, leftLowerArmAngle, rightUpperArmAngle, rightLowerArmAngle, 
        leftUpperLegAngle, leftLowerLegAngle, rightUpperLegAngle, rightLowerLegAngle) {
    ...
    const processMovements = async () => {
        ...
        // Define the number of variations you want to generate
        const numberOfVariations = 5; // You can change this to generate more or fewer variations
    
        // Process each movement preset using map and Promise.all
        const variations = await Promise.all(
            Array.from({ length: numberOfVariations }, (_, index) => {
                const angleConfig = {
                    leftUpperArmAngle: generateRandomAngle(0, 90),
                    leftLowerArmAngle: generateRandomAngle(0, 90),
                    rightUpperArmAngle: generateRandomAngle(0, 90),
                    rightLowerArmAngle: generateRandomAngle(0, 90),
        ...
        // Process results using map instead of forEach
